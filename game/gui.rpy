...
define gui.accent_color = '#2AE4FD'
...
## 인-게임 글자에 사용됩니다.
define gui.text_font = "ONE Mobile POP.ttf"

## 캐릭터의 이름에 사용됩니다.
define gui.name_text_font = "ONE Mobile POP.ttf"

## 인터페이스에 사용됩니다.
define gui.interface_text_font = "ONE Mobile POP.ttf"
...
define gui.quick_button_text_idle_color = "#FF69B4"  # 선택되지 않았을 때 색상 (핫핑크)
define gui.quick_button_text_selected_color = "#D8BFD8"  # 선택되었을 때 색상 (연보라색)
...
## 메인 메뉴 글자의 위치입니다.
define gui.main_menu_text_xalign = 5.0
